...
export default function OnboardingTour() {
  ...
  const steps: TourStep[] = [
    { icon: <AppstoreAddOutlined />, title: t("tourStepCraftTitle"), desc: t("tourStepCraftDesc") },
    { icon: <GoldOutlined />, title: t("tourStepRelicTitle"), desc: t("tourStepRelicDesc") },
    { icon: <TrophyOutlined />, title: t("tourStepMasteryTitle"), desc: t("tourStepMasteryDesc") },
    { icon: <ThunderboltFilled />, title: t("tourStepCommandTitle"), desc: t("tourStepCommandDesc") },
    { icon: <BgColorsOutlined />, title: t("tourStepThemeTitle"), desc: t("tourStepThemeDesc") },
  ];
