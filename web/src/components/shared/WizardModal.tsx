...
export default function WizardModal() {
  ...
  const steps: WizardStep[] = [
    { id: "welcome", icon: <RocketOutlined />, title: t("wizardWelcomeTitle"), description: t("wizardWelcomeDesc") },
    { id: "language", icon: <GlobalOutlined />, title: t("wizardLanguageTitle"), description: t("wizardLanguageDesc") },
    { id: "theme", icon: <BgColorsOutlined />, title: t("wizardThemeTitle"), description: t("wizardThemeDesc") },
    { id: "ready", icon: <CheckCircleOutlined />, title: t("wizardReadyTitle"), description: t("wizardReadyDesc") },
  ];
