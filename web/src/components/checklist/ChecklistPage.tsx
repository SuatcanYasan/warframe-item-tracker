...
type ChecklistType = "daily" | "weekly";
...
export default function ChecklistPage() {
  ...
  const items = useChecklistStore((s) => s.items) as ChecklistItem[];
  ...
  const [newType, setNewType] = useState<ChecklistType>("daily");
  ...
  function renderGroup(list: ChecklistItem[], titleKey: string, _typeTag: ChecklistType) {
  ...
  return (
    <div className="checklist-page">
      ...
      <div className="checklist-add">
        ...
        <Segmented
          value={newType}
          onChange={(v) => setNewType(v as ChecklistType)}
          options={[
      ...
      {totalItems === 0 ? (
        <EmptyState
          ...
          onSecondary={() => (document.querySelector(".checklist-add input") as HTMLInputElement | null)?.focus()}
        />
      ) : (
        <>
