...
import type { WarframeEntry } from "../../constants/wfRotation";
import { hideImgOnError } from "../../utils/helpers";

const WF_ICONS = "https://wiki.warframe.com/images";

function warframeIconUrl(name: string): string {
...
export default function WFRotationPage() {
  ...
  interface WarframePillProps {
    warframe: WarframeEntry;
    groupKey: string;
    highlight?: boolean;
  }

  function WarframePill({ warframe, groupKey, highlight }: WarframePillProps) {
