...
function handleImgError(e) {
  ...
  e.target.src = ARCANE_FALLBACK_IMAGE;
}

function ArcaneCard({ arcane, count, onChange, t }) {
...
function getZoneLabelKey(zoneId) {
...
export default function ArcaneTrackerPage() {
  ...
  const totalOwned = useMemo(() => {
    return Object.values(arcaneCounts).reduce((sum, n) => sum + (Number(n) || 0), 0);
  }, [arcaneCounts]);
